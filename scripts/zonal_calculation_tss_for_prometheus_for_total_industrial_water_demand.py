...
def main():
    ...
    out_directory     = "/scratch-shared/edwin/country_scale_total_industrial_gross_water_demand_estimate_based_on_aqueduct_2021/historical/"
    ...
    output_file_code = "country_scale_total_industrial_gross_water_demand_historical"
    ...
    attributeDictionary = {}
    attributeDictionary['title'      ]  = "Estimate of total industrial gross water demand at the country scale."
    ...
    attributeDictionary['description']  = "Created by Edwin H. Sutanudjaja, see https://github.com/edwinkost/pgb_data_for_prometheus_primes/blob/main/scripts/zonal_calculation_tss_for_prometheus_for_total_industrial_water_demand.py"
