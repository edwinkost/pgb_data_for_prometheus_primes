...
if __name__ == "__main__":
    ...
    inputFiles['industryGrossDemand']  = directory_for_water_demand + "/" + "industry_water_demand_historical_1960-2019.nc"
    inputFiles['industryGrossDemand']  = str(sys.argv[6])
    #
    # - fraction for spliting electricity water demand
    inputFiles['electricity_fraction'] =  "/home/edwinbar/github/edwinkost/pgb_data_for_prometheus_primes/pow_man_split/pow_man_split.map"

    # output that will be calculated 
    output = {}
    variable_names  = "gross_water_demand_for_electricity_production"
    ...
    attributeDictionary['description']  = "PCR-GLOBWB files from the Aqueduct runs 2021, prepared by Edwin H. Sutanudjaja."
    ...
    for iYear in range(staYear, endYear+1):
        ...
        output[var]['pcr_value'] = pcr.scalar(0.0) 
        ...
        for iMonth in range(0, 12+1):
            ...
            for var in inputFiles.keys():        
                ...
                inpval[var]['pcr_value'] = vos.netcdf2PCRobjClone(ncFile = inputFiles[var],\
                                                                  varName = "automatic",\
                ...
                # accumulate the values over months
                output[var]['pcr_value'] = output[var]['pcr_value'] + inpval[var]['pcr_value'] * number_of_days_in_this_month                                                   
        
        # calculate the estimate of electricity water demand
        output[var]['pcr_value'] = output[var]['pcr_value'] * electricity_fraction 
